...
Verified: 17 fast backend tests, 5 live-model tests, frontend typecheck/build/4 tests, 6/6 classroom prompts, browser smoke, and offline loopback acceptance.
