...
| Performance | `evaluation/run_latency_eval.py --rounds 2` | recorded: route, switch, generation, RAM/VRAM/GPU |
| Browser | `scripts/browser-smoke.ps1`; Playwright desktop/mobile/manual checks | passing; console errors 0 |
