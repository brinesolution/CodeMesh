...
export function ChatView({ sessionId, messages, input, mode, isStreaming, error, route, validation, metrics, onInput, onModeChange, onSend, onStop, onPrompt, onRegenerate }: Props) {
