...
describe("ContextMeshOverlay", () => {
  it("keeps the visualizer open while navigating its four views and closes on Escape", () => {
    ...
    expect(screen.getByText("SPECIALIST SYSTEM PROMPT")).toBeInTheDocument();
