...
const mesh: ContextMeshData = {
  ...
  memory: { facts: [], decisions: [{ id: "language", key: "project.language", text: "Language = Java 21", source_message_id: 8, updated_at: "2026-09-20T10:08:00Z", topic: "calculator", status: "current" }], constraints: [], preferences: [], current_goal: "Add JUnit tests", open_tasks: [], topics: ["Java"] },
  memory_history: [],
